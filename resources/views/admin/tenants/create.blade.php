...
<h1 class="text-2xl font-semibold mb-6">Add New Tenant</h1>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="date" name="lease_start" id="lease_start" value="{{ old('lease_start') }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-brand focus:border-brand">
                @error('lease_start')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="date" name="lease_end" id="lease_end" value="{{ old('lease_end') }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-brand focus:border-brand">
                @error('lease_end')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
